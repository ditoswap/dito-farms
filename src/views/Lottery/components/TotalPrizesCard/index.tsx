...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from 'dito-uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} DTO</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
